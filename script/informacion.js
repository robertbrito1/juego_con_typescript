...
export function mostrarGrupoVisual(lista) {
...
export function despedir(indice) {
    // 1. Obtenemos los datos actuales
    let partida = cargarSesion(); // Aseguramos que no sea null, ya que esta función solo se llama si hay una partida cargada
